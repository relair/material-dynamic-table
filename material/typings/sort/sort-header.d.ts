...
export interface SortHeaderStrategy {
    ...
    getSortCounter(sortHeader: MatSort | MatMultiSort, id: string, getSortCounter: ((position: number, count: number) => string)): string;
}
/**
...
export declare class MatSortHeader extends _MatSortHeaderMixinBase implements CanDisable, MatSortable, OnDestroy, OnInit {
    ...
    private _sort;
    private _sortHeaderStrategy;
    getSortCounter: ((position: number, count: number) => string);
    constructor(_intl: MatSortHeaderIntl, changeDetectorRef: ChangeDetectorRef, _simpleSort: MatSort, _multiSort: MatMultiSort, _columnDef: MatSortHeaderColumnDef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    /**
