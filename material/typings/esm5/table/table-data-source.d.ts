...
import { MatSort, MatMultiSort } from '@angular/material/sort';
/**
...
export declare class MatTableDataSource<T> extends DataSource<T> {
     ...
     */
    sort: MatSort | MatMultiSort | null;
    private _sort;
    /**
    ...
    compareValues(valueA: string | number, valueB: string | number, direction: string): number;
    /**
