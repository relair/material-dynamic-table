 ...
 * Container for MatSortables to manage the sort state and provide default sort parameters.
 */
class MatMultiSort extends _MatSortMixinBase {
    constructor() {
        super(...arguments);
        /**
         * Used to notify any child components listening to state changes.
    ...
    getNextSortDirection(sortable) {
        ...
        // Get the sort direction cycle with the potential sortable overrides.
        /** @type {?} */
        let sortDirectionCycle = getSortDirectionCycle$1(sortable.start || this.start);
        // Get and return the next direction in the cycle
        /** @type {?} */
...
class MatSortHeader extends _MatSortHeaderMixinBase {
     ...
     * @param {?} _columnDef
     */
    constructor(_intl, changeDetectorRef, _simpleSort, _multiSort, _columnDef) {
        ...
        super();
        this._intl = _intl;
        this._simpleSort = _simpleSort;
        this._multiSort = _multiSort;
 ...
 */
class SimpleSortStrategy {
    /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
    isSorted(sortHeader, id) {
...
class MultiSortStrategy {
     ...
     * @return {?}
     */
    getSortCounter(sortHeader, id, getSortCounter) {
