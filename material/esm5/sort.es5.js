 ...
 * @return {?}
 */
function getMultiSortInvalidDirectionError(direction) {
    /** @type {?} */
    var values = typeof direction === 'object' ?
        Object.keys(direction).map(function (id) { return direction[id]; }) :
        direction;
...
MatSortBase = /** @class */ (function () {
     ...
     * @return {?}
     */
    MatSortBase.prototype.register = /**
     * Register function to be used by the contained MatSortables. Adds the MatSortable to the
     * collection of MatSortables.
     * @param {?} sortable
     * @return {?}
     ...
     * @return {?}
     */
    MatSortBase.prototype.deregister = /**
     * Unregister function to be used by the contained MatSortables. Removes the MatSortable from the
     * collection of contained MatSortables.
     * @param {?} sortable
     * @return {?}
...
var MatMultiSort = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MatMultiSort.prototype, "direction", {
        /**
     ...
     * @return {?}
     */
    MatMultiSort.prototype.isSortDirectionValid = /**
     * @param {?} direction
     * @return {?}
     */
    function (direction) {
        var _this = this;
        return Object.keys(direction).every(function (id) { return _this.isIndividualSortDirectionValid(direction[id]); });
    };
    /**
     * @param {?} direction
     * @return {?}
     */
    MatMultiSort.prototype.isIndividualSortDirectionValid = /**
     * @param {?} direction
     * @return {?}
     */
    function (direction) {
    ...
    function (sortable) {
        if (!Array.isArray(this.active)) {
            ...
            /** @type {?} */
            var index = this.active.indexOf(sortable.id);
            if (index === -1) {
     ...
     * @return {?}
     */
    MatMultiSort.prototype.getNextSortDirection = /**
     * Returns the next sort direction of the active sortable, checking for potential overrides.
     * @param {?} sortable
     * @return {?}
     */
    function (sortable) {
        ...
        // Get the sort direction cycle with the potential sortable overrides.
        /** @type {?} */
        var sortDirectionCycle = getSortDirectionCycle$1(sortable.start || this.start);
        // Get and return the next direction in the cycle
        /** @type {?} */
        var direction = this.direction[sortable.id];
        /** @type {?} */
        var nextDirectionIndex = sortDirectionCycle.indexOf(direction) + 1;
        if (nextDirectionIndex >= sortDirectionCycle.length) {
            nextDirectionIndex = 0;
        }
        return sortDirectionCycle[nextDirectionIndex];
     ...
     * @return {?}
     */
    MatMultiSort.prototype.ngOnInit = /**
     * @return {?}
     */
    function () {
        this._markInitialized();
     ...
     * @return {?}
     */
    MatMultiSort.prototype.ngOnChanges = /**
     * @return {?}
     */
    function () {
        this._stateChanges.next();
     ...
     * @return {?}
     */
    MatMultiSort.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () {
        this._stateChanges.complete();
 ...
 * @return {?}
 */
function getSortDirectionCycle$1(start) {
    /** @type {?} */
    var sortOrder = ['asc', 'desc'];
    if (start == 'desc') {
        sortOrder.reverse();
...
var MatSortHeader = /** @class */ (function (_super) {
    ...
    function MatSortHeader(_intl, changeDetectorRef, _simpleSort, _multiSort, _columnDef) {
        var _this = 
        ...
        _this._intl = _intl;
        _this._simpleSort = _simpleSort;
        _this._multiSort = _multiSort;
        ...
        if (_simpleSort) {
            _this._sort = _simpleSort;
            _this._sortHeaderStrategy = new SimpleSortStrategy();
        }
        else if (_multiSort) {
            _this._sort = _multiSort;
            _this._sortHeaderStrategy = new MultiSortStrategy();
        }
        else {
            throw getSortHeaderNotContainedWithinSortError();
        }
        /** @type {?} */
        var _sort = _this._sort;
    ...
    function () {
        ...
        /** @type {?} */
        var direction = this._sortHeaderStrategy.getDirection(this._sort, this.id);
     ...
     * @return {?}
     */
    MatSortHeader.prototype._getSortCounter = /**
     * Gets the sort counter that will display whenever multisort is enabled. It shows the order
     * in which sort is applied, whenever there are multiple columns being used for sorting.
     * @return {?}
     */
 ...
 * Strategy used when MatSort is used
 */
SimpleSortStrategy = /** @class */ (function () {
    function SimpleSortStrategy() {
    }
    /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
    SimpleSortStrategy.prototype.isSorted = /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
     ...
     * @return {?}
     */
    SimpleSortStrategy.prototype.getDirection = /**
     * @param {?} sortHeader
     * @return {?}
     */
    function (sortHeader) {
     ...
     * @return {?}
     */
    SimpleSortStrategy.prototype.getSortCounter = /**
     * @return {?}
     */
    function () {
        return '';
 ...
 * Strategy used when MatMultiSort is used
 */
MultiSortStrategy = /** @class */ (function () {
    function MultiSortStrategy() {
    }
    /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
    MultiSortStrategy.prototype.isSorted = /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
     ...
     * @return {?}
     */
    MultiSortStrategy.prototype.getDirection = /**
     * @param {?} sortHeader
     * @param {?} id
     * @return {?}
     */
     ...
     * @param {?} sortHeader
     * @param {?} id
     * @param {?} getSortCounter
     * @return {?}
     */
    MultiSortStrategy.prototype.getSortCounter = /**
     * @param {?} sortHeader
     * @param {?} id
     * @param {?} getSortCounter
     * @return {?}
     */
    function (sortHeader, id, getSortCounter) {
        if (!getSortCounter || !sortHeader.active) {
            return '';
        }
        /** @type {?} */
        var index = sortHeader.active.indexOf(id);
        if (index === -1) {
            return '';
        }
        return getSortCounter(index, sortHeader.active.length);
    };
    return MultiSortStrategy;
}());
...
export { MatSortModule, MatSortHeaderBase, _MatSortHeaderMixinBase, MatSortHeader, MAT_SORT_HEADER_INTL_PROVIDER_FACTORY, MatSortHeaderIntl, MAT_SORT_HEADER_INTL_PROVIDER, MatSortBase, _MatSortMixinBase, MatSort, MatMultiSort, matSortAnimations };
